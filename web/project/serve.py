#!/usr/bin/env python3
"""Serve this kipr project review on http://127.0.0.1:<random port>/ and open it in the browser.

    python3 serve.py [--port N] [--no-browser]

Needed for the gerber and 3D views; double-clicking index.html
...
class Handler(http.server.SimpleHTTPRequestHandler):
    extensions_map = {**http.server.SimpleHTTPRequestHandler.extensions_map,
                      ...
                      ".gbr": "text/plain; charset=utf-8", ".drl": "text/plain; charset=utf-8",
                      ".glb": "model/gltf-binary", ".gbrjob": "application/json"}
